...
class USchema2CodeProfileConfig
{
  Path inputModel
  Path outputPath
  ...
  new()
  {
    ...
    this.outputPath = Path.of(defaultProperties.getProperty("folder_uschema2codeprofile"))
  }
  ...
  new(String[] args)
  {
    ...
    try
    {
      ...
      if (cmd.hasOption("h"))
      {
        formatter.printHelp("<USchema2CodeProfile Main>", options)
        System.exit(0)
      }
