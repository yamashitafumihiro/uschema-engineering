...
public class ModelWriterTest
{
  ...
  private String modelWriterContent = "Schema ModelWriterTest:1\r\n" + 
      "\r\n" + 
      "fset commons\r\n"
      + "{\r\n"
      + "  id: String,\r\n"
  ...
  public void setUp()
  {
    ...
    testPath = Path.of("models/WriterTest.athena");
    resultFile = "models/WriterTest_result";
  }

  @AfterEach
  public void tearDown()
  {
    new File(resultFile + ".athena").delete();
    new File(resultFile + ".xmi").delete();
  }
  ...
  public void testStringModelWriter()
  {
    ...
    athenaIO.write(schema, Path.of(resultFile + ".athena"));
    schema = athenaIO.load(Path.of(resultFile + ".athena"));

    assertEquals(modelWriterContent, athenaIO.serialize(schema));
  }
  ...
  {
    AthenaSchema schema = createSchema();
    athenaIO.writeXMI(schema, Path.of(resultFile + ".xmi"));
    schema = athenaIO.load(Path.of(resultFile + ".xmi"));
  ...
  public void testFileModelWriter()
  {
    ...
    athenaIO.writeXMI(schema, Path.of(resultFile + ".athena"));
    schema = athenaIO.load(Path.of(resultFile + ".athena"));
