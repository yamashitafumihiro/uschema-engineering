...
class AthenaNormalizerConfig
{
  ...
  new()
  {
    ...
    this.inputPath = null
    this.outputPath = Path.of(defaultProperties.getProperty("folder_normalization"))
  }
  ...
  new(String[] args)
  {
    ...
    try
    {
      ...
      if (cmd.hasOption("h"))
      {
        formatter.printHelp("<AthenaNormalizer Main>", options)
        System.exit(0)
      }
