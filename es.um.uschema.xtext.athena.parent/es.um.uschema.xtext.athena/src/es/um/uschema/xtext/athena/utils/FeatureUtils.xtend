...
import es.um.uschema.xtext.athena.athena.AthenaFactory
...
class FeatureUtils
{
  ...
  static def SimpleFeature mergeFeaturesWithSameName(SimpleFeature sFeat1, SimpleFeature sFeat2)
  {
    ...
    if (!(type1 instanceof PrimitiveType) || !(type2 instanceof PrimitiveType))
      throw new IllegalAthenaOperationException("Feature \"" +  getName(sFeat1) + "\": Cannot merge \"" + type1.class.simpleName + "\" and \"" + type2.class.simpleName + "\"")
  ...
  static def SimpleFeature subtractFeaturesWithSameName(SimpleFeature sFeat1, SimpleFeature sFeat2)
  {
    ...
    if (!(type1 instanceof PrimitiveType) || !(type2 instanceof PrimitiveType))
      throw new IllegalAthenaOperationException("Feature \"" +  sFeat1.name + "\": Cannot subtract \"" + type1.class.simpleName + "\" and \"" + type2.class.simpleName + "\"")
  ...
  static def SimpleFeature intersectFeaturesWithSameName(SimpleFeature sFeat1, SimpleFeature sFeat2)
  {
    ...
    if (!(type1 instanceof PrimitiveType) || !(type2 instanceof PrimitiveType))
      throw new IllegalAthenaOperationException("Feature \"" +  getName(sFeat1) + "\": Cannot intersect \"" + type1.class.simpleName + "\" and \"" + type2.class.simpleName + "\"")
