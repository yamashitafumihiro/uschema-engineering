 ...
 */
package es.um.uschema.xtext.athena.formatting2
...
class AthenaFormatter extends AbstractFormatter2
{
  ...
  def dispatch void format(AthenaSchema schema, extension IFormattableDocument document)
  {
    ...
    schema.id.regionFor.keyword(":").prepend[noSpace].append[noSpace]
    ...
    val semRegion = schema.id.regionFor.feature(Literals.SCHEMA_ID__VERSION)
  ...
  def dispatch void format(SimpleAggregateTarget aggr, extension IFormattableDocument document)
  {
