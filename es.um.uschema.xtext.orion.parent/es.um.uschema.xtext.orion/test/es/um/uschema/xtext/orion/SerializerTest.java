...
public class SerializerTest
{
  ...
  public void testXtextModelLoader()
  {
    ...
    orion.getOperations().add(factory.createReferenceMultiplicityOp(factory.createMultipleFeatureSelector("EntityRefs", Arrays.asList("strRefSimpleChange", "numRefSimpleChange")), "+"));
    orion.getOperations().add(factory.createReferenceMultiplicityOp(factory.createMultipleFeatureSelector("EntityRefs", Arrays.asList("strRefArrayChange", "numRefArrayChange")), "&"));
