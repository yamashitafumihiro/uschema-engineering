...
class FeatureOpTest
{
  private Path testPath_1 = Path.of("models/tests/m2m/feature_ops/ImportFeature_Ops.orion");
  private Path testPath_2 = Path.of("models/tests/m2m/feature_ops/ScriptFeature_Ops.orion");
