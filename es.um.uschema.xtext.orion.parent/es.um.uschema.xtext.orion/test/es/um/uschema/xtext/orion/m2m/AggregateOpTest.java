...
{
  private Path testPath_1 = Path.of("models/tests/m2m/aggregate_ops/ImportAggregate_Ops.orion");
  private Path testPath_2 = Path.of("models/tests/m2m/aggregate_ops/ScriptAggregate_Ops.orion");
  ...
  void testAggregateOperations_Script()
  {
    ...
    assertEquals("Schema ScriptAggregate_Ops:1\r\n"
        + "\r\n"
