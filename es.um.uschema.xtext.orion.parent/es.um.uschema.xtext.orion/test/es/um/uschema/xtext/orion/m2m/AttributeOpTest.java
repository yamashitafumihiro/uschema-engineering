...
{
  private Path testPath_1 = Path.of("models/tests/m2m/attribute_ops/ImportAttribute_Ops.orion");
  private Path testPath_2 = Path.of("models/tests/m2m/attribute_ops/ScriptAttribute_Ops.orion");
  ...
  void testAttributeOperations_Script()
  {
    ...
    assertEquals("Schema ScriptAttribute_Ops:1\r\n"
        + "\r\n"
