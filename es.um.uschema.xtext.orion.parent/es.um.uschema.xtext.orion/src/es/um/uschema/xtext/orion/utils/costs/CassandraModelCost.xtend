...
class CassandraModelCost
{
  ...
  private def dispatch OperationCost getCostFrom(AttributeCastOp op)         { return OperationCost.VERY_HIGH_COST_OP  }
  private def dispatch OperationCost getCostFrom(AttributePromoteOp op)      { return OperationCost.VERY_HIGH_COST_OP  }
  private def dispatch OperationCost getCostFrom(AttributeDemoteOp op)       { return OperationCost.VERY_HIGH_COST_OP  }

  private def dispatch OperationCost getCostFrom(ReferenceAddOp op)          { return OperationCost.CONSTANT_TIME_OP   }
  private def dispatch OperationCost getCostFrom(ReferenceCastOp op)         { return OperationCost.VERY_HIGH_COST_OP  }
  ...
  private def dispatch OperationCost getCostFrom(AggregateMultiplicityOp op) { return OperationCost.NOT_IMPLEMENTED_OP }
  private def dispatch OperationCost getCostFrom(AggregateMorphOp op)        { return OperationCost.NOT_IMPLEMENTED_OP }
  ...
  private def dispatch OperationCost getCostFrom(EntitySplitOp op)           { return OperationCost.HIGH_COST_OP       }
  private def dispatch OperationCost getCostFrom(EntityMergeOp op)           { return OperationCost.HIGH_COST_OP       }

  private def dispatch OperationCost getCostFrom(EntityDelVarOp op)          { return OperationCost.NOT_IMPLEMENTED_OP }
  private def dispatch OperationCost getCostFrom(EntityAdaptOp op)           { return OperationCost.NOT_IMPLEMENTED_OP }
  private def dispatch OperationCost getCostFrom(EntityUnionOp op)           { return OperationCost.NOT_IMPLEMENTED_OP }
