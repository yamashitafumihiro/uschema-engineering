...
import es.um.uschema.xtext.orion.m2m.Orion2Athena
import es.um.uschema.xtext.orion.utils.config.Orion2AthenaConfig
...
class Orion2AthenaMain
{
  ...
  {
    // val customArgs = newArrayList("-i", "../../es.um.uschema.xtext.athena.parent/es.um.uschema.xtext.athena/models/orion/mongosongs_phased.orion", "-o", "models/")
