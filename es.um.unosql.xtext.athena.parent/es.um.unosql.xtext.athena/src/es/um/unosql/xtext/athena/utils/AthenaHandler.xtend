...
class AthenaHandler
{
  ...
  def dispatch DataType getInnerTypeFromCollection(es.um.unosql.xtext.athena.athena.List collection) { return collection.elementType }
  def dispatch DataType getInnerTypeFromCollection(es.um.unosql.xtext.athena.athena.Set collection)  { return collection.elementType }
