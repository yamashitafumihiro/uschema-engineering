package es.um.uschema.subtypes.util.configuration;
...
import es.um.uschema.subtypes.timestamp.templates.BasicTimestampAnalyzer;
import es.um.uschema.subtypes.timestamp.templates.DateTimestampAnalyzer;
import es.um.uschema.subtypes.timestamp.templates.DefaultTimestampAnalyzer;
import es.um.uschema.subtypes.timestamp.templates.OIDTimestampAnalyzer;
import es.um.uschema.subtypes.timestamp.templates.TimestampAnalyzer;
import es.um.uschema.subtypes.util.configuration.defaults.DefaultTimestampInferenceConfig;
