package es.um.uschema.subtypes.timestamp.output;
...
import es.um.uschema.subtypes.timestamp.output.chart.TimestampLineChart;
...
public class TimestampCSVWriter
{
  ...
  public void generateOutput(Path outputFolder, USchema schema)
  {
  ...
  private void generateCSVFile(Path outputFolder, USchema schema)
  {
  ...
  private void generateConsoleOutput(USchema schema)
  {
  ...
  private void generateChartFile(Path outputFolder, USchema schema)
  {
  ...
  private Map<EntityType, EList<StructuralVariation>> orderSchemaMap(USchema schema)
  {
