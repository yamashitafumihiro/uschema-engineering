package es.um.uschema.subtypes.timestamp.output.chart;
...
public class TimestampLineChart extends ApplicationFrame
{
  ...
  public void saveChart(Path outputFolder)
  {
    if (chart == null)
    {
      System.err.println(schemaName + " > " + entityName + " only contains variations without timestamps");
    ...
    try
    {
      File chartFile = outputFolder.resolve(schemaName).resolve(schemaName + "_" + entityName + ".png").toFile();
